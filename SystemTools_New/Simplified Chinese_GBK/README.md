声明：此文件只为标准程序开发的最后一步，作者还在学习，只能做这些了，希望谅解！
版本：4.0
版权：可搬运无限制
...
Declaration
This file represents only the final step in standard program development. The author is still learning and can only accomplish this much; your understanding is appreciated!

Version: 4.0
Copyright: Freely redistributable, no restrictions.
...
Erklärung
Diese Datei stellt nur den letzten Schritt der Standard-Programmentwicklung dar. Der Autor befindet sich noch im Lernprozess und kann daher nicht mehr bieten – um Verständnis wird gebeten!

Version: 4.0
Urheberrecht: Frei weitergebbar, ohne Einschränkungen.
